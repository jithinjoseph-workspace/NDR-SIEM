...
Cmnd_Alias NDR_SYSTEMCTL = /usr/bin/systemctl daemon-reload, /usr/bin/systemctl start ndr-agent, /usr/bin/systemctl stop ndr-agent, /usr/bin/systemctl restart ndr-agent, /usr/bin/systemctl enable ndr-agent, /usr/bin/systemctl disable ndr-agent, /usr/bin/systemctl status ndr-agent, /usr/bin/systemctl start ndr-autoscaler, /usr/bin/systemctl stop ndr-autoscaler, /usr/bin/systemctl restart ndr-autoscaler, /usr/bin/systemctl enable ndr-autoscaler, /usr/bin/systemctl disable ndr-autoscaler, /usr/bin/systemctl start ndr-worker-autoscaler, /usr/bin/systemctl stop ndr-worker-autoscaler, /usr/bin/systemctl restart ndr-worker-autoscaler, /usr/bin/systemctl enable ndr-worker-autoscaler, /usr/bin/systemctl disable ndr-worker-autoscaler, /usr/bin/systemctl start ndr-updater, /usr/bin/systemctl stop ndr-updater, /usr/bin/systemctl restart ndr-updater, /usr/bin/systemctl enable ndr-updater, /usr/bin/systemctl start ndr-vector, /usr/bin/systemctl stop ndr-vector, /usr/bin/systemctl restart ndr-vector, /usr/bin/systemctl enable ndr-vector, /usr/bin/systemctl start suricata, /usr/bin/systemctl stop suricata, /usr/bin/systemctl restart suricata, /usr/bin/systemctl start zeek, /usr/bin/systemctl stop zeek
