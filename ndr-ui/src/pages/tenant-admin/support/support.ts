...
export class TenantSupport implements OnInit, OnDestroy {
  ...
  readonly isTenantAdmin    = true;
  readonly isSuperAdmin     = false;
  readonly isManager        = true;
  readonly canSubmitRequest = false;
  readonly pageTitle        = 'Tenant Support';
  readonly pageDescription  = 'Review tenant user requests, reply, delete, or forward important items.';
